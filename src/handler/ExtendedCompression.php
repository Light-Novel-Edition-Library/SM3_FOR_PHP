...
require_once 'src/types/Word.php';
require_once 'src/handler/Substitution.php';
require_once 'src/handler/SmallJHandler.php';
require_once 'src/handler/BigJHandler.php';
